...
import { noAction } from 'apps/metrics/libs/utils';
...
const AuthLecturerRanking = (props: Props) => {
    ...
    },
    {
      ...
      render: (rowData) => (
        <Link
          href={'#'}
          onClick={noAction}
          className="bg-[#3265AF] text-white p-1 rounded-[50%]"
        >
          {rowData.position}
        </Link>
      ),
...
export default AuthLecturerRanking;
